Ext.define('ux.signaturefield', {
    ...
    initialize: function(){
        ...
        this.actionOverlayCanvas = Ext.create('ux.signature.Canvas', {
            //additional config
        });
        ...
        this.actionOverlayCanvas.setStyle('border:none;height:'+this.height+'px;width:'+this.width+'px;margin-right:auto;margin-left:auto;margin-top:auto;margin-bottom:auto;');

        //now lets check to see if we have toDataURL support for android if not use JPEGEncoder
        var tdu = HTMLCanvasElement.prototype.toDataURL;
        var encoder = new this.JPEGEncoder();
        ...
        //this.openCanvasSheet();
    },
    setReadOnly: function() {
        this.element.on('tap', function(){}, this);
    },
    initCanvas: function(){		
    ...
    canvasTouchStart: function(e) {
        ...
        coords = this.actionOverlayCanvas.element.dom.firstChild.relMouseCoords(e);
