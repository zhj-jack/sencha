    ...
    createSlot: function(name, days, months, years,hours,minutes,ampm) {
        switch (name) {
            case 'year':
                return {
                    name: 'year',
                    align: 'center',//(Ext.os.deviceType.toLowerCase() == "phone") ? 'left' : 'center',
                    data: years,
            ...
            case 'month':
                return {
                    name: name,
                    align: 'center',//(Ext.os.deviceType.toLowerCase() == "phone") ? 'left' : 'right',
                    data: months,
            ...
            case 'day':
                return {
                    name: 'day',
                    align: 'right',//(Ext.os.deviceType.toLowerCase() == "phone") ? 'left' : 'center',
                    data: days,
            ...
            case 'minute':
                return {
                    name: 'minute',
                    align: 'left',//(Ext.os.deviceType.toLowerCase() == "phone") ? 'left' : 'center',
                    data: minutes,
